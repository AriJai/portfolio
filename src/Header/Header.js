...
const Header = () => {
    ...
    return (
        <header className={`${styles.header_main_container}`} id='header_main_container' >
            ...
            <div className={`${styles.hamburger} ${toggle.activeHamburger ? styles.active : ""}`} id="ham" onClick={toggleHamburger} >
            ...
            <div className={`${styles.nav} ${toggle.activeHamburger ? styles.nav_mobile : ""}`} id="nav" >
                <nav id="header">
            ...
            {
                isLightmode ?
                    <div onClick={handleVisibility} className={styles.wrapper}>
                        <svg viewBox="0 0 24 24" className={styles.visibility} aria-label="Light mode" id="sun">
                    ...
                    :
                    <div onClick={handleVisibility} className={styles.wrapper}>
                        <svg viewBox="0 0 24 24" className={styles.visibility} aria-label="Dark mode" id="moon" >
            ...
            <div className={`${toggle.activeHamburger ? styles.main_mobile : ""}`} onClick={toggleHamburger}></div>
