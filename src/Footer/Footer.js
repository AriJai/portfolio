    ...
    <footer className={`wrap ${styles.mainContainer}`}>
        <div className={`content ${styles.footerContainer}`}>
            ...
            <p>I&apos;d like to use this section of the web app to put any final thoughts.<br></br>
                Thank you to my friends, my family, and my love for supporting me throughout this journey. I have had a blast with what I have accomplished, and look forward to what can be done in the future.<br></br>Happy coding!</p>
