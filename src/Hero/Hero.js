...
const Hero = () => {
    ...
    const handleClick = (site) => {
        if( site === 'linkedIn') {
            window.open('http://www.linkedin.com/in/arian-jaihooni-5112b1279', '_blank');
        }
        if( site === 'github') {
            window.open('https://github.com/AriJai', '_blank');
        }
    };
    ...
    return (
        <section className={styles.hero_section}>
            ...
            <div className={styles.social_media}>
                <div className={styles.social_div} onClick={()=>handleClick('linkedIn')}>
                    ...
                    <p className={styles.social_label}>LinkedIn</p>
                </div>
                <div className={styles.social_div}onClick={()=>handleClick('github')}>
                    ...
                    <p className={styles.social_label}>Github</p>
                </div>
            </div>
        </section>
